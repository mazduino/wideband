 ...
 * GPIOB setup:
 *
 * PB3  - Nernst ESR driver, LSU4.2 (GPIO)  (input by default, driven output by SetupESRDriver())
 * PB4  - Nernst ESR driver, LSU ADV (GPIO) (input by default, driven output by SetupESRDriver())
 * PB5  - Blue LED                  (output pushpull)
 * PB6  - Green LED                 (output pushpull)
 * PB7  - Nernst ESR driver, LSU4.9 (GPIO)  (input by default, driven output by SetupESRDriver())
 */
